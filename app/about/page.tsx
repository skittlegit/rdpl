      ...
      <section className="py-12 md:py-20 lg:py-28 bg-paper-soft dark:bg-ink-soft border-t border-zinc-200 dark:border-zinc-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-10 md:gap-16 items-start">
            ...
            <div className="lg:w-[280px] shrink-0 border border-zinc-200 dark:border-zinc-700 rounded-2xl overflow-hidden bg-paper dark:bg-ink">
              ...
              <div className="px-5 py-4 border-t border-zinc-200 dark:border-zinc-700">
                <p className="text-[12px] font-semibold text-ink dark:text-paper">A. Venkat Reddy</p>
                <p className="text-[11px] text-ink/55 dark:text-paper/45 mt-0.5">Founder &amp; MD · Est. 2004</p>
              </div>
            </div>
          </div>
        </div>
